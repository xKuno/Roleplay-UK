...
tables = {
	...
	{
		coords = vector4(1129.41, 262.36, -52.04, 135.31),
		highStakes = true,
		color = 3,
		zone = "casino"
	},
...
customTables = {
	-- Script uses inZone for theese tables to work the area will need be added to that
    {
        coords = vector4(1143.34, 264.25, -52.84, 225.00),
		highStakes = false,
		color = 0,
		zone = "casino"
    },
    {
        coords = vector4(1146.33, 261.25, -52.84, 45),
		highStakes = false,
		color = 0,
		zone = "casino"
    },
	{
        coords = vector4(1148.74, 251.69, -52.04, 315),
		highStakes = true,
		color = 3,
		zone = "casino"
    },
	{
        coords = vector4(1133.74, 266.69, -52.04, 315),
		highStakes = true,
		color = 3,
		zone = "casino"
    },
	{
		coords= vector4(967.5, 32.0, 115.2, 239),
		highStakes = true,
		color = 3,
		zone = "penthouse"
	},
...
bettingNums = {
	...
	80,
	90,
	100, -- 10 Old High-limit Tables minimum bet limit
	150,
	200,
	250,
	300,
	...
	4000,
	4500,
	5000, -- 27 Old low-table limit, betting numbers added after this will be high stakes only
	6000,
	7000,
	8000,
	9000,
	10000, --32 new High limit min bet limit
	15000,
	20000,
	25000,
	30000,
	...
	40000,
	45000,
	50000, -- 40 new low-limit tables max bet
	55000,
	60000,
	65000,
	70000,
...
function SetDealerVoice(ped, index)
	...
	SetAmbientVoiceNameHash(ped, GetHashKey(FemaleDealerVoices[index]))
...
function SetDealerOutfit(ped, outfit)
	...
	if outfit == 1 then --OK FEMALE ASIAN #1
		SetPedDefaultComponentVariation(ped)
		...
		return
	elseif outfit == 2 then -- OK ASIAN FEMALE #3
		SetPedDefaultComponentVariation(ped)
		...
		SetPedComponentVariation(ped, 11, 0, 1, 0)
		return
	elseif outfit == 3 then --OK LATINA FEMALE #2
		SetPedDefaultComponentVariation(ped)
		...
		return
	elseif outfit == 4 then --OK LATINA FEMALE #3
		SetPedDefaultComponentVariation(ped)
		...
		return
	elseif outfit == 5 then -- OK ASIAN FEMALE #2
		SetPedDefaultComponentVariation(ped)
		...
		SetPedComponentVariation(ped, 11, 0, 1, 0)
		return
	elseif outfit == 6 then --OK ASIAN FEMALE #4
		SetPedDefaultComponentVariation(ped)
		...
		SetPedComponentVariation(ped, 4, 1, 0, 0)
		SetPedComponentVariation(ped, 6, 2, 0, 0)
		SetPedComponentVariation(ped, 7, 3, 0, 0)
		SetPedComponentVariation(ped, 8, 0, 0, 0)
		SetPedComponentVariation(ped, 10, 0, 0, 0)
		SetPedComponentVariation(ped, 11, 0, 1, 0)
		return
	elseif outfit == 7 then --OK lATINA FEMALE #1
		SetPedDefaultComponentVariation(ped)
