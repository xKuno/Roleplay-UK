Config = {
	...
	EnableInCam = {245, 249, 200, 288, 172, 173, 27, 177, 191, 201, 215, 18, 212, 213, 214, 111}, -- What controls are enabled while in cam? 245 is INPUT_MP_TEXT_CHAT_ALL, and 249  is INPUT_PUSH_TO_TALK
	UseModifier = false,
	Keys = {
		Modifier = 21, -- INPUT_SPRINT, Left Shift
		Toggle = 121, -- INPUT_FRONTEND_PAUSE, P
