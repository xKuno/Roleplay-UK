...
Citizen.CreateThread(function()
    FinanceOrganization = exports['iplFix']:GetFinanceOrganizationObject()

    FinanceOrganization.Name.Set("Richards Majestic", FinanceOrganization.Name.Style.normal, FinanceOrganization.Name.Colors.silver, FinanceOrganization.Name.Fonts.font9)
