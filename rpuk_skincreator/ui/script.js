$(document).ready(function () {
	...
	$('input').change(function () {
		$.post('https://rpuk_skincreator/updateSkin', JSON.stringify({
			value: false,
			// Face
	...
	$(document).keypress(function (e) {
		if (e.which == 97) { // A pressed
			$.post('https://rpuk_skincreator/rotaterightheading', JSON.stringify({
				value: 10
			}));
		}
		if (e.which == 100) { // E pressed
			$.post('https://rpuk_skincreator/rotateleftheading', JSON.stringify({
				value: 10
			}));
		}
	});
	...
	$('#tabs label').on('click', function (e) {
		//e.preventDefault();
		$.post('https://rpuk_skincreator/zoom', JSON.stringify({
